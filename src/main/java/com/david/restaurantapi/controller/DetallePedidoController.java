...
public class DetallePedidoController {
     ...
     */
    @Operation(summary = "Obtener todos los detalles de pedido", description = "Devuelve la lista completa de detalles de pedido registrados en el restaurante.")
    @ApiResponses({
     ...
     */
    @Operation(summary = "Buscar detalle de pedido por ID", description = "Devuelve un detalle de pedido segun su identificador unico.")
    @ApiResponses({
     ...
     */
    @Operation(summary = "Guardar nuevo detalle de pedido", description = "Registra un nuevo detalle de pedido en el sistema.")
    @ApiResponses({
     ...
     */
    @Operation(summary = "Eliminar detalle de pedido por ID", description = "Elimina un detalle de pedido del sistema segun su identificador.")
    @ApiResponses({
